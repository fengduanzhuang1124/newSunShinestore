...
截至2026-09-17，`inventory-system/` 已完成员工登录、扫码入库、手工出库、库存查询、入库单、盘点、库存流水、临期预警和手机端适配；Moni POS 已按只读原则完成门店、商品、订单、奶粉候选及 Level 4 价格的数据接入。本地商品主档已支持中英文名称、SKU、多条码和 POS 映射，手机端未提交入库内容可按员工与门店自动恢复。POS 自动正式扣减和生产部署仍未启用。
