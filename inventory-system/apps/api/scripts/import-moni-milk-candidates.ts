...
import { PosMilkCatalogService } from '../src/pos/application/pos-milk-catalog.service.js';
...
const milkCatalog = new PosMilkCatalogService(prisma, products);
...
try {
  ...
  const result = await milkCatalog.importCandidates(
